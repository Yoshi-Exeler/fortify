...
// hasTracerPID check if a debugger is present using the TracerID flag in the /proc/self/status
func (p *Policy) hasTracerPID() bool {
...
// detectTimeSkips will raise a violation if time flows incorrectly.
